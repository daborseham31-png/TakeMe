...
type Mode = "" | "ride" | "deliver";

export default function PersonalScreen() {
  const [mode, setMode] = useState<Mode>("");

  if (mode === "ride") {
    return <RideForm category="personal" showPets onBack={() => setMode("")} />;
  }
    ...
    <SafeAreaView style={styles.page}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.card}>
          <Text style={styles.title}>Personal Rides</Text>
          ...
          >
            ...
            <View style={styles.column}>
              <Text style={styles.licenseButtonText}>Ride (Person)</Text>
          ...
          >
            ...
            <View style={styles.column}>
              ...
              <Text style={styles.subtitleSmall}>Send an item to someone</Text>
            </View>
          </Pressable>
        </View>
      </ScrollView>
    ...
    <SafeAreaView style={styles.page}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.label}>Price (₪) if needed</Text>
          <View style={styles.inputRow}>
