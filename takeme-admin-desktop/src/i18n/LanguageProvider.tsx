...
// Desktop build: there is no Expo Go concept here at all (Electron is its
// own dedicated native root, same as a standalone build), so this is always
// false — see the comment above for why that's the safe branch either way.
